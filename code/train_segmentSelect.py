...
Modified by Tristan Faine, Antoine Jamelot / University of Nantes
...
This script is used to train a CNN that is meant to recognize whether a on-line handwritten symbol 
is a valid mathematical symbol or structure, or if its junk and therefore should be ignored


Temp stuff (TODO):
#charger image ds entrainement, utiliser lib pytorch : datasetfolder vu qu'on a deja les images organisees.
...
#TODO: check training image size/layers, might already be in range -1, 1
...
#TODO: Refer to junk and non-junk properly

fulltrainset = torchvision.datasets.ImageFolder(root='./data/valid_symbols', transform=transform)
